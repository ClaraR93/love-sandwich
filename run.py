...
def get_sales_data():
    ...
    """
    while True:
        print("Please enter sales data from the lask market")
...
"""
original code before refactoring, see below commented out code
...
def main():
    ...
    stock_data = calcuate_stock_data(sales_columns)
